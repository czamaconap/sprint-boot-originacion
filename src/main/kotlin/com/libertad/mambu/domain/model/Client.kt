...
data class Client(
    ...
    @SerializedName("addresses") var addresses: List<Address>? = emptyList(),
    @SerializedName("_Clientes_N2") var clientN2: ClientN2? = null,
    ...
    @SerializedName("groupLoanCycle") var groupLoanCycle: Int? = null,
